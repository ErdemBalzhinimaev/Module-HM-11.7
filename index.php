...
<body>
    ...
    <div>Выводы о сравнении в PHP</div>
        <ol>
            ...
            <li>Из-за того, что в PHP при сравнении строк, содержащих числа, оператор == пытается преобразовать их в числа, результат порой может оказаться неожиданным:</li>
